...
let zipCode = rl.question("What zip could would you like to see tomorrow's temperature for? ", function (zipCode) {
    ...
    axios
        ...
        const filteredData = response.data.list.filter(function (item) {
            // the .filter() created an additional array with all of the elements that are considered true to the following function
